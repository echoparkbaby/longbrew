...
VERSION="1.1.0"          # CFBundleShortVersionString (must stay numeric)
VERSION_DISPLAY="1.1.0"  # what the menu shows
DMG_SUFFIX="1.1.0"       # what the DMG file is called
BUILD="12"                # CFBundleVersion — monotonic build number (integer)
